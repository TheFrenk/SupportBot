...
async def get_name(message: Message, state: FSMContext):
    ...
    await message.answer('Отправьте по кнопке ваш номер телефона', reply_markup=kb.send_number)
...
async def get_number(message: Message, state: FSMContext):
    ...
    await message.answer('Напишите свой запрос', reply_markup=ReplyKeyboardRemove())
