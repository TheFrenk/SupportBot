...
], resize_keyboard=True, input_field_placeholder='Отправьте телефон по кнопке ниже')
...
async def all_tickets():
    ...
    for ticket in tickets:
        keyboard.add(InlineKeyboardButton(text=f'Тикет #{ticket.id}', callback_data=f'ticket_{ticket.id}'))
